export const TRANSLATIONS = {
  "zh-CN": {
    "ui": {
      ...
      "mine_tab": "我的",
      "online": "在线",
      "ai_intro": "你好，旅人。我是子期，你的内心宇宙向导。今天感觉如何？",
      "ai_placeholder": "输入消息...",
      "user_name": "星尘用户",
      "premium": "高级会员",
      "my_reports": "我的报告",
      ...
      "retake_test": "重新测试",
      "start_test": "开始测试",
      "quit_confirm": "确认返回主界面吗？",
      "quit_confirm_msg": "未保存的进度将丢失。",
  ...
  "en": {
    "ui": {
      ...
      "restart": "Retest",
      "quit_confirm": "Confirm return to main menu?",
      "quit_confirm_msg": "Unsaved progress will be lost.",
